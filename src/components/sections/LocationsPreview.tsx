      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Find us at major airports across India, serving quality meals to travelers
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {locations.map((location) => (
            <Card key={location.id} className="group hover:shadow-medium transition-smooth bg-card/80 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{location.airport}</p>
                    </div>
                  </div>
                  <Badge 
                    variant={location.status === 'operational' ? 'default' : 'secondary'}
                    className={location.status === 'operational' 
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-foreground font-medium">{location.terminal}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-foreground font-medium">{location.hours}</span>
                  </div>
                </div>
        ...
        <div className="text-center">
          <Link to="/outlets">
            <Button size="lg" className="bg-gradient-primary hover:shadow-glow transition-smooth group">
              View All Locations
